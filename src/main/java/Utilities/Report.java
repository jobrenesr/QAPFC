...
//Metodo que trae el dia, mes, año y hora para colocarla en los archivos
	...
	public void configuracionReporte() {
		htmlReporter = new ExtentHtmlReporter(
				System.getProperty("user.dir") + "/reportes/ExtentReport" + getCurrentLocalDateTimeStamp() + ".html");
	...
	public void obtenerResultado(ITestResult result) throws IOException {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			logger.log(Status.FAIL, MarkupHelper.createLabel(result.getName() + " La prueba fallo, ver detalles abajo:",
					ExtentColor.RED));
